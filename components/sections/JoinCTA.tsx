    ...
    <section style={{ background: "#050505", borderTop: "1px solid rgba(255,255,255,0.06)", padding: "64px 24px", textAlign: "center" }}>
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <a href="/race-check-in" style={{ background: "#FACC15", color: "#050505", padding: "13px 26px", borderRadius: 8, ...F, fontWeight: 900, fontSize: 15, letterSpacing: 2, textDecoration: "none" }}>{FEATURE_FLAGS.onlineRaceTicketsEnabled ? "🎟️ BUY TICKETS" : "🏁 RACE DAY"}</a>
