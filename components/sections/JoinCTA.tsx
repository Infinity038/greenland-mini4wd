    ...
    <section style={{ background: "#071426", borderTop: "1px solid rgba(220,38,38,0.2)", padding: "64px 24px", textAlign: "center" }}>
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <a href="/tickets" style={{ background: "#FACC15", color: "#050505", padding: "14px 28px", borderRadius: 8, fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 900, fontSize: 16, letterSpacing: 2, textDecoration: "none" }}>🎟️ BUY TICKETS</a>
