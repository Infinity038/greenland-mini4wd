...
export default function ShopPreview() {
  return (
    <section id="shop" className="relative bg-[#0F1923] px-5 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="text-center mb-4">
          ...
          <h2 className="font-black text-[#F4F4F0] leading-none mb-4"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {ITEMS.map((item) => (
            <div key={item.id} className="relative bg-[#0d0d0d] border border-white/[0.07] rounded-lg overflow-hidden">
        ...
        <div className="text-center">
          <button className="border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-[#0d0d0d] px-10 py-3.5 rounded font-bold text-sm tracking-widest transition-all duration-200 cursor-pointer bg-transparent"
