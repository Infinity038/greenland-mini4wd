      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, color: "#B8C1CC", marginTop: 16, maxWidth: 560, margin: "16px auto 0" }}>
            Registration is free and required before anyone can use the track, join tournaments, or complete Race Check-In. One-time sign-up, lifetime community access.
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 24, marginBottom: 48 }}>
          {[
            ...
            { step: "03", title: "Race Check-In", desc: "Enter tournaments by completing Race Check-In in person on race day. Separate from registration.", color: "#DC2626" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16, marginBottom: 40 }}>
          {[
            ...
            { icon: "🏁", text: "Race Check-In is completed in person, per tournament" },
