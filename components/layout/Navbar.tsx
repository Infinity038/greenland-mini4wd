        ...
        <div style={{ background: "#050505", borderTop: "1px solid rgba(255,255,255,0.05)", padding: "8px 16px 24px" }}>
          {NAV_LINKS.map((link) => (
            <a key={link.label} href={link.href} onClick={() => setOpen(false)}
              style={{ display: "block", padding: "14px 0", borderBottom: "1px solid rgba(255,255,255,0.05)", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 22, color: "#F5F5F5", letterSpacing: 3 }}>
              {link.label}
            </a>
          ))}
