...
// Verbatim copy of the pre-existing app/admin/page.tsx dashboard, moved
// here unchanged so it can keep serving as the default behavior when
// NEXT_PUBLIC_SUPABASE_AUTH_ENABLED is false/absent — see page.tsx for the
// feature-flag branch. Do not "clean up" or dedupe against
// AdminDashboardContent.tsx as part of an unrelated change; the two are
// intentionally separate until the flag becomes the only path (see
// docs/OWNER-BOOTSTRAP-AND-AUTH-ROLLOUT.md).
