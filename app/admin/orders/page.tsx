...
// Cloudinary's console/media-library URL (res-console.cloudinary.com) needs a logged-in
// dashboard session to load — works on your desktop while you're logged into Cloudinary,
// fails everywhere else (mobile, other devices, logged-out). Auto-fix to the public CDN URL.
function fixImageUrl(url: string): string {
  if (!url) return url;
  return url.split(',').map(u => u.trim().replace(
