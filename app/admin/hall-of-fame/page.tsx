...
export default function AdminHallOfFame() {
    ...
    return (<div style={s.page}>
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
        ...
        {/* EDIT FORM */}
        {editing && (<div style={{ ...s.card, border: '1px solid rgba(250,204,21,0.3)' }}>
        ...
        <div style={s.card}>
          ...
          {records.map((r: any) => {
            ...
            return (<div key={r.id} style={{ ...s.goldCard, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                  ...
                  {r.member_name !== 'TBD' && (<div style={s.meta}>Set {new Date(r.achieved_at).toLocaleDateString('en-GB')}</div>)}
                  {r.previous_holder_name && (<div style={{ ...s.meta, marginTop: '4px' }}>Prev: {r.previous_holder_name} — {r.previous_record_value}</div>)}
                </div>
