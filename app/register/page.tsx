    ...
    <div style={{ background: "#050505", minHeight: "100vh", color: "#F5F5F5" }}>
      ...
      <div style={{ padding: "48px 24px 80px" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          {errorMsg && (
            <div style={{ background: "rgba(255,68,68,0.1)", border: "1px solid rgba(255,68,68,0.3)", borderRadius: 8, padding: "12px 16px", marginBottom: 16 }}>
              <p style={{ color: "#ff6b6b", margin: 0, fontFamily: "'DM Sans', sans-serif", fontSize: 14 }}>{errorMsg}</p>
            </div>
          )}
